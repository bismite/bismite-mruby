...
void main()
{
  ...
  color1 = vec4(c.r, 0.0, 0.0, c.a ); // R
  color2 = vec4(0.0, c.g, 0.0, c.a ); // G
  color3 = vec4(0.0, 0.0, c.b, c.a ); // B
  color4 = vec4(0.0, c.g, c.b, c.a ); // C
  color5 = vec4(c.r, 0.0, c.b, c.a ); // M
  color6 = vec4(c.r, c.g, 0.0, c.a ); // Y
  color7 = vec4(0.0, 0.0, 0.0, c.a ); // K
}
