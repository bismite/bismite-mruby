...
ARGV.each do |command|
  case command
  when "--libs"
    puts "-L#{root}/lib -L#{root}/bin -lmruby -lbismite-core -lbismite-ext -lmingw32 -lSDL2main -lSDL2 -mwindows -lSDL2_mixer -lSDL2_image -lopengl32 -lws2_32 -lyaml -lmsgpackc"
  when "--cflags"
